...
- The flow canvas is produced automatically: `runshot gallery` lays out each run's
  screens in flow order (one frame per screen, arrows between them) in the Screens
  tab. Nothing extra to invoke.
